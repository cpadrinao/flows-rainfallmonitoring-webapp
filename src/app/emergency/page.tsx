      ...
      <header className="flows-fixed-top-nav bg-[#111827]/95 border-b border-[#374151]/70 px-4 sm:px-6 py-3 flex flex-col md:flex-row justify-between items-center gap-3 backdrop-blur-md shadow-lg transition-all duration-300">
        ...
        <div className="flex md:hidden items-center justify-between w-full gap-2 border-t border-[#374151]/30 pt-2 select-none">
          ...
          <div className="flex items-center gap-1.5 bg-[#1F2937]/55 border border-[#374151]/60 px-2.5 py-1.5 rounded-lg shadow-inner flex-1 justify-center h-[38px] max-h-[38px] min-w-0 mobile-header-card">
            <Clock size={11} className="text-[#EF4444] shrink-0" />
          ...
          {/* Date & Time Card */}
          <div className="flex items-center gap-1.5 bg-[#1F2937]/55 border border-[#374151]/60 px-2.5 py-1.5 rounded-lg shadow-inner flex-1 justify-center h-[38px] max-h-[38px] min-w-0 mobile-header-card">
            <Radio size={11} className="text-[#EF4444] animate-pulse shrink-0" />
            <div className="text-left leading-none min-w-0">
              <span className="text-[7px] font-black text-[#EF4444] tracking-wider uppercase block">PH TIME</span>
              <div className="flex items-center gap-1 mt-0.5">
                ...
                <span className="text-[6px] font-black text-[#EF4444] bg-[#EF4444]/10 px-0.5 rounded inline-flex items-center shrink-0">
                  PH
                </span>
              </div>
            </div>
